    ...
    <div class="flex bg-gray-100 w-full">
        ...
        <main class="flex-col bg-indigo-50 w-full ml-4 pr-6">
            <div class="flex justify-between mt-4 space-x-4 s">
                <a href="/associations/create" class="bg-indigo-800 hover:bg-indigo-600 text-white font-bold py-5 px-6 rounded">
                    New Associations
                </a>                 
            </div>
                              ...
                              <table class="min-w-full">
                                ...
                                <tbody>
                                  <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                                    ...
                                    <td class="text-sm text-gray-900  px-6 py-4 whitespace-nowrap">
                                        School Of Information And Technology Communication 
                                    </td>
